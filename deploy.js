...
// Build Docker image
const imageName = `ghcr.io/beingflo/marending-dev:${newVersion}`;
...
const oldImageLine = `image: "ghcr.io/beingflo/marending-dev:${version}"`;
const newImageLine = `image: "ghcr.io/beingflo/marending-dev:${newVersion}"`;
