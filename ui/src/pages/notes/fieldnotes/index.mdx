...
import { Title, Img, Details, Li, Info, Code, Hint } from 'src/components';
...
<ul class="pb-4">
	...
	<Li>
		Client generates an encryption key for this note using
	...
	<Li>
		Client wraps encryption key using main key with
...
<Code value="https://fieldnotes.land/note/uUpZgnUOeamS6SefalXjVVYb5zXChGh1#yLOOY5rCqxL0eJaZYPFrU2NzwHWqf+kkzCXNYUVLnrI=" />
or simplified:
