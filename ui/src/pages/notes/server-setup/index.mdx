...
Now, I can bring up for this very website with the following command:
...
in this repo. Btw. for _reasons_ this website is not a naked bundle of static assets, but instead
a Rust application that serves said bundle.
