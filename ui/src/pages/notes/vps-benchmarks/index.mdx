...
[Hetzner](https://www.hetzner.com/) has been my go to hosting provider for some time, thanks to
their reliability and low cost. Some months ago they started offering Ampere-based ARM servers on
their VPSs. They offer more cores and more RAM for the same money. It sounds very appealing to me to
move away from x86 entirely, since my development machine is also ARM based (Macbook M1). But before
I migrate my setup to ARM servers I wanted to run some basic benchmarks to see what I'm getting
myself into.
