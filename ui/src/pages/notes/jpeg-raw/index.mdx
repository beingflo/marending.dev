---
title: 'Should I shoot in JPEG or RAW?'
subtitle: 'Or both?'
date: '9 June 2025'
link: '/notes/jpeg-raw/'
...
I've been taking pictures on vacation and around the house for a couple of years now
as a way to document life to look back on later. But after all this time, I'm still
not happy with my photo workflow. The central question is whether I should shoot primarily
JPEG, only RAW or something in between.

This is one of those notes where I'm mostly trying to sort my thoughts into some cohesive form.
...
Alternatively of course, you can wrangle RAWs into any series of pixels physically possible (including
...
them in the future. I rarely do, but you never know. The term 'data hoarder' comes to mind. Unrelated
thought.

This workflow is somewhat convoluted, that's why I'm reevaluating it. I don't like that I have to
juggle two file types. I also don't like that 
