...
Recently Parquet added the Variant type, a binary encoding of primitives, arrays or object of
...
This dumps all of the data into a single Parquet file with just over 10 million rows and weighing
800 MB.
...
coordinates into a map and is left as an exercise to the reader._
...
first been isolated to their respective datasets, ClickHouse has an assortment of data in its
...
the `Map` flavour. Honestly quite surprised. Goes to show that while you want to get to those
