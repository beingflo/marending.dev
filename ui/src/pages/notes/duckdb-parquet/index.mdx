...
this must truly be a limitation in that will be addressed at some point. Looking at the query plan
with `EXPLAIN ANALYZE`, it's clear that a lot of variant extractions happen, even though in my
...
single-digit milisecond latencies, in real world usage these fractions of a second are still fine.
