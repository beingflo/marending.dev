...
the last line. Tags do not get a special treatment other than being displayed in a lighter
...
By default the datepicker show the current date and time, but I quickly found that sometimes
...
That's pretty much the functionality that I use every day. One additional eye-candy I added
...
in the lab journal or as a new note in the note pad.
