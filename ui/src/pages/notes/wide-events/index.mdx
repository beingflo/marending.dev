...
the thought process that I need a broader observability system than what Prometheus can give me.
...
spans mimic log lines, except they are naturally associated with a particular request. No
