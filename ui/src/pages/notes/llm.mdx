...
**Try local model on my jour data set**: Not working. Context too small or they just can't keep track of anything.
...
- Humans learn, LLMs don't
- Be fair to the model
