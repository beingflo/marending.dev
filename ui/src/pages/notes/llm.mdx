...
- The documentation on OTEL is a complete mess, Claude can help here to break down concepts that are
not understandable otherwise.
- Trying to get traces into Clickhouse: Collector from otel-contrib is beta
- Claude was extremely helpful it standing up a compose stack of grafana, clickhouse and otel-collector
- Query for grafana dashboard: Extremely useful!
