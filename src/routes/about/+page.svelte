<main class="p-4 pt-12 md:p-24 grid gap-2 gap-y-8 grid-cols-1 lg:grid-cols-2">
	<div>
		<h1 class="font-normal text-2xl pb-4">Hi</h1>
		...
		<div class="flex flex-row gap-2 pt-4">
			<a href="https://github.com/beingflo" target="_blank" rel="noreferrer noopener">
				<svg width="16px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512"
			...
			>
			<a href="https://linkedin.com/in/florian-marending" target="_blank" rel="noreferrer noopener">
				<svg width="16px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
					><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
